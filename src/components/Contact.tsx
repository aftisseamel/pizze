...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-stone-300 dark:bg-stone-800 text-stone-900 dark:text-stone-100">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-stone-100 dark:bg-stone-700 p-8 rounded-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-stone-900 dark:text-stone-100">2 Rue royal, 59000, Lille</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-stone-900 dark:text-stone-100">+33 (123) 456-7890</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-stone-900 dark:text-stone-100">Lundi - Vendredi: 11H - 20H</p>
                  <p className="text-stone-900 dark:text-stone-100">Samedi - Dimanche: 12H - 22H</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="bg-stone-200 dark:bg-stone-600 p-3 rounded-full hover:bg-yellow-500 transition-colors">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-2 rounded bg-stone-200 dark:bg-stone-600 border border-stone-600 dark:border-stone-400 focus:outline-none focus:ring-2 focus:ring-yellow-500"
              ...
              <button 
                type="submit" 
                className="bg-yellow-500 text-stone-900 dark:text-stone-900 px-6 py-3 rounded font-medium hover:bg-yellow-400 transition-colors"
              >
                Envoyer le message
              </button>
            </form>
        ...
        <div className="mt-12">
          <div className="bg-stone-100 dark:bg-stone-700 p-4 rounded-lg h-[400px]">
            <iframe 
